...
export default function Page({
  ...
  const [vote, setVote] = useState(
    session?.user.likes_posts?.includes(actualAddon) || false
  );
  const [like, setLike] = useState(addon.likes);
            ...
            <Button
              ...
              onClick={() => {
                ...
                if (!vote) {
                  ...
                  setVote(true);
                  setLike((prev) => prev + 1);
                  db.setAddonState({ likes: like + 1 }, actualAddon);
